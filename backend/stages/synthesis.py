...
Purpose
-------
This module owns the local FSM and stage-specific behaviour for the Synthesis
macro-stage.
...
def handle_stage(session: Session) -> StageReply:
    """
    Handle one turn for the Synthesis stage.
    ...
    debug message.
    """
    session.debug_message = "Synthesis stage handler invoked."
