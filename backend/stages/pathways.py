...
Purpose
-------
This module owns the local FSM and stage-specific behaviour for the Pathways
macro-stage.
...
def handle_stage(session: Session) -> StageReply:
    """
    Handle one turn for the Pathways stage.
    ...
    debug message.
    """
    session.debug_message = "Pathways stage handler invoked."
