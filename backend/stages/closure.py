...
Purpose
-------
This module owns the local FSM and stage-specific behaviour for the Closure
macro-stage.
...
def handle_stage(session: Session) -> StageReply:
    """
    Handle one turn for the Closure stage.
    ...
    debug message.
    """
    session.debug_message = "Closure stage handler invoked."
